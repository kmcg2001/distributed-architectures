...
namespace APIClasses
{
    ...
    public static class Blockchain
    {
        ...
        /// </summary>
        public static void AddFirstBlock()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static uint GetHighestBlockID()
        {
        ...
        private static void GetAccounts(out List<uint> accountIDs, out List<float> accountBalances)
        {
        ...
        /// <returns></returns>
        public static float GetAccountBalance(uint inAccountID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static ChainState GetState()
        {
        ...
        /// <returns></returns>
        public static Block HashBlock(Block newBlock)
        {
            SHA256 sha256 = SHA256.Create();
